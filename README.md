...
> Installers are provided by [cargo-dist](https://opensource.axo.dev/cargo-dist/) and always point to the latest release.
> After installation, run `aipm-update` to self-update to newer versions.

...
///
/// Extracted from [`current_platforms`] so every branch — including OS
/// values that differ from the OS actually running the tests — can be
...
mod tests {
    ...
    #[test]
    fn platforms_for_os_covers_every_known_and_unknown_value() {

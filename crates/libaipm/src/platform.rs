...
/// the corresponding [`Platform`] list. Extracted from [`current_platforms`]
/// so every branch can be exercised in tests regardless of the OS the test

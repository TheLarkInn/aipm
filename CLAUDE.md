...
|---|---|---|---|
| `improve-coverage.md` | 45 min | Every 15 min | Finds uncovered branches, writes tests, opens PRs; repairs or supersedes unmergeable coverage PRs and escalates stuck ones via issue instead of silently `noop`ing |

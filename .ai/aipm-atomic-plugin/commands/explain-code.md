...
model: opus
allowed-tools: Glob, Grep, NotebookRead, Read, ListMcpResourcesTool, ReadMcpResourceTool, WebFetch, WebSearch
...
- **WebFetch/WebSearch**: Use to look up documentation for external libraries, frameworks, and GitHub repositories. Particularly useful for understanding third-party dependencies and their APIs.
...
7. **Framework and Library Usage**
   ...
   - Use WebFetch/WebSearch tool to look up documentation for external libraries when needed
...
- Use WebFetch/WebSearch to look up external library documentation when encountering unfamiliar dependencies
